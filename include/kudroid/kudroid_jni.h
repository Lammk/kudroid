...
// Creates and initializes the miniJVM instance if it hasn't been already.
void kudroid_jni_init_jvm(const char* bootclasspath, const char* classpath);

// Destroys the miniJVM instance and cleans up.
void kudroid_jni_destroy_jvm(void);

// Retrieves the global JavaVM mock instance used by kudroid.
